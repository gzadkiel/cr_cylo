...
logic                      l_fft1_s_axis_config_tready; // added latch
...
//==============================================================================
// latch config_tready value 
always_latch begin : latch_config_tready
...
//==============================================================================
// concatenate input_window output to store values in a single ram
