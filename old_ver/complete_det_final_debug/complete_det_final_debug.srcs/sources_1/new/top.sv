...
logic [31            : 0] w_cb_OUT_REGS_0_reg1_o;
logic [31            : 0] w_cb_IN_REGS_0_reg0_i;

logic [31            : 0] w_cb_IN_REGS_0_reg1_i; // power LSB
logic [31            : 0] w_cb_IN_REGS_0_reg2_i; // power MSB
logic [31            : 0] w_cb_IN_REGS_0_reg3_i; // thres LOW
logic [31            : 0] w_cb_IN_REGS_0_reg4_i; // thres MID
logic [31            : 0] w_cb_IN_REGS_0_reg5_i; // thres HIG
...
logic signed [NB_THRESHOLD                        - 1 : 0] top_mux_threshold;
logic signed [2*NB_DATA + $clog2(N_NOISE_SAMPLES) - 1 : 0] top_mux_noise_power;

logic top_mux_scd_mode;

// ---------------------------------------------------------------------------------------
// its required to latch detection_done and detect in order for the PS to sample correctly
logic [15 : 0] l_detect;
logic          l_detection_done;

// when signal_valid is set to 1, detection process begins
// onces its done, latch the detect and detect_done values
// until signal_valid is set to 0 once again

always_ff @(posedge ps_clock) begin
    if      (top_mux_reset             ) l_detection_done <= '0;
    else if (!top_mux_signal_data_valid) l_detection_done <= '0;
    else if (top_mux_detection_done    ) l_detection_done <= '1;
    else                                 l_detection_done <= l_detection_done;
end

always_ff @(posedge ps_clock) begin
    if      (top_mux_reset             ) l_detect <= '0;
    else if (!top_mux_signal_data_valid) l_detect <= '0;
    else if (top_mux_detection_done    ) l_detect <= top_mux_detect;
    else                                 l_detect <= l_detect;
end
// ---------------------------------------------------------------------------------------
...
comblock_adapter_inst (
    ...
    .i_cb_OUT_REGS_0_reg1_o           (w_cb_OUT_REGS_0_reg1_o          ),
    .o_cb_IN_REGS_0_reg0_i            (w_cb_IN_REGS_0_reg0_i           ),
    .o_cb_IN_REGS_0_reg1_i            (w_cb_IN_REGS_0_reg1_i           ),
    .o_cb_IN_REGS_0_reg2_i            (w_cb_IN_REGS_0_reg2_i           ),
    .o_cb_IN_REGS_0_reg3_i            (w_cb_IN_REGS_0_reg3_i           ),
    .o_cb_IN_REGS_0_reg4_i            (w_cb_IN_REGS_0_reg4_i           ),
    .o_cb_IN_REGS_0_reg5_i            (w_cb_IN_REGS_0_reg5_i           ),
    ...
    .top_mux_scd_mode                 (top_mux_scd_mode                ),
    .top_mux_data_re                  (top_mux_data_re                 ),
    .top_mux_data_im                  (top_mux_data_im                 ),
    .top_mux_threshold                (top_mux_threshold               ),
    .top_mux_noise_power              (top_mux_noise_power             ),
    .top_mux_detect                   (l_detect                        ),
    .top_mux_detection_done           (l_detection_done                ),
...
pm_top_mux_inst (
    ...
    .i_scd_mode           (top_mux_scd_mode          ),
    .i_data_re            (top_mux_data_re           ),
    .i_data_im            (top_mux_data_im           ),
    .o_threshold          (top_mux_threshold         ),
    .o_noise_pow          (top_mux_noise_power       ),
...
comblock_setup_wrapper comblock_setup_wrapper_inst (
    ...
    .IN_REGS_0_reg1_i            (w_cb_IN_REGS_0_reg1_i           ),
    .IN_REGS_0_reg2_i            (w_cb_IN_REGS_0_reg2_i           ),
    .IN_REGS_0_reg3_i            (w_cb_IN_REGS_0_reg3_i           ),
    .IN_REGS_0_reg4_i            (w_cb_IN_REGS_0_reg4_i           ),
    .IN_REGS_0_reg5_i            (w_cb_IN_REGS_0_reg5_i           ),
    ...
    .OUT_REGS_0_reg1_o           (w_cb_OUT_REGS_0_reg1_o          ),
    .PS_CLOCK0                   (ps_clock                        ),
    .fifo_clear_i_0              (top_mux_reset                   ),
    .fifo_clk_i_0                (ps_clock                        ));
