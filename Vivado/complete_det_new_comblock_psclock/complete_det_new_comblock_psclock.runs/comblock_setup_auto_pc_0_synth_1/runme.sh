...
HD_PWD='C:/Users/gm/Vivado Projects/complete_det_new_comblock_psclock/complete_det_new_comblock_psclock.runs/comblock_setup_auto_pc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log comblock_setup_auto_pc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source comblock_setup_auto_pc_0.tcl
