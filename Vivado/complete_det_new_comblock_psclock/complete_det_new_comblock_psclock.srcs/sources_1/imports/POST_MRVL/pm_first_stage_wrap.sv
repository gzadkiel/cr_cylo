...
//ram2d_col_write_col_read # (
//    // using P_max value, with N 1024 and L 16
//    .ROWS (NP), .COLS (P_MAX), .W (NB_DATA_O))
//real_ram (
//    .clk         (clock                   ),
//    .wr_port_en  (w_ram_write_port_en     ),
//    .wr_col_en   (w_window_output_valid_re),
//    .wr_col      (w_ram_write_addr        ),
//    .wr_col_data (w_window_output_re      ),
//    .rd_col_en   (w_ram_read_port_en      ),
//    .rd_col      (w_ram_read_addr         ),
//    .rd_col_data (w_ram_data_out_re       ));
...
//    .clk         (clock                   ),
//    .wr_port_en  (w_ram_write_port_en     ),
//    .wr_col_en   (w_window_output_valid_im),
//    .wr_col      (w_ram_write_addr        ),
//    .wr_col_data (w_window_output_im      ),
//    .rd_col_en   (w_ram_read_port_en      ),
//    .rd_col      (w_ram_read_addr         ),
//    .rd_col_data (w_ram_data_out_im       ));
...
first_stage_fsmd_control (
    ...
    //.i_ram_data_out_re      (w_ram_data_out_re          ),
    //.i_ram_data_out_im      (w_ram_data_out_im          ),
