module pm_input_window #(
    ...
    // input logic signed [NB_WINDOWS - 1 : 0] i_windows [NP],
...
localparam NB_L      = $clog2(L) ;                                            //! up counter limit bits
...
always_comb begin  
    case (i_window_sel)
        ...
        2'b01 : begin
            ...
            w_window_coeff[2 ] = 8'b00000000;
            w_window_coeff[3 ] = 8'b00000001;
            w_window_coeff[4 ] = 8'b00000010;
            w_window_coeff[5 ] = 8'b00000011;
            w_window_coeff[6 ] = 8'b00000101;
            w_window_coeff[7 ] = 8'b00000111;
            w_window_coeff[8 ] = 8'b00001001;
            w_window_coeff[9 ] = 8'b00001100;
            w_window_coeff[10] = 8'b00001111;
            w_window_coeff[11] = 8'b00010011;
            w_window_coeff[12] = 8'b00010111;
            w_window_coeff[13] = 8'b00011100;
            w_window_coeff[14] = 8'b00100001;
            w_window_coeff[15] = 8'b00100111;
        end 
        2'b10 : begin
            // rectangular
...
always_comb begin : product_output
