module theshold_calculator #(
	...
	output logic o_thres_est_done // PARA QUE EL PS SEPA QUE ESTA OK
);
...
// localparam NBF_THRESHOLD      = NBF_THRESHOLD;                                            //! Output threshold frac bits                                       
                                                                                             // in case noise_var is big enough, leave 1 bit as guard if its ~1 (NB - 2)
...
// AGREGADO PARA QUE EL PS SEPA QUE EL RUIDO YA ESTA
assign o_thres_est_done = w_var_done;

//always_comb begin : threshold_estimation
