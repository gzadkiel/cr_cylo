...
//logic [NB_NOISE_CNT - 1 : 0] r_noise_sample_counter_reg, w_noise_sample_counter_next;
...
//assign w_noise_sample_counter_out  = (r_noise_sample_counter_reg == N_NOISE_SAMPLES - 1) ? '1 : '0;

//assign w_noise_sample_counter_out  = (r_noise_sample_counter_reg == i_noise_size - 1) ? '1 : '0;
// mod porq el macc del estimador de varianza tiene un clockmde delay, cuento una mas
assign w_noise_sample_counter_out  = (r_noise_sample_counter_reg == i_noise_size + 1) ? '1 : '0;
...
//assign w_scd_sample_counter_out1 = (r_scd_sample_counter_reg == N_DESIRED_SAMPLES - 1) ? '1 : '0;
assign w_scd_sample_counter_out1 = (r_scd_sample_counter_reg == i_data_size - 1) ? '1 : '0;
//assign w_scd_sample_counter_out2 = (r_scd_sample_counter_reg == N_TOTAL_SAMPLES - 1) ? '1 : '0; 
...
always_comb begin : control_fsmd
    ...
    case (state_reg)
        ...
        INPUT_SCD_WAIT_VALID : begin
            // w_noise_var_est_done = '1;
            if (i_signal_data_valid) begin
                w_det_counter_reset = '1; // una vez q estoy para mandar mas datos, reseteo y arranca de nuevo
                w_scd_estimate_en   = '1;
        ...
        ESTIMATE_SCD : begin
            ...
            if (i_scd_estimate_done) begin
                // w_det_counter_reset = '1; // lo saco de aca para q el o_detect mantenga el valor hasta q lo levante el PS
