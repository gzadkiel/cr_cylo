...
// Description: 
// Parameterizable 2D RAM with ROWS Ã- COLS organization and data width W. 
...
// | wr_col_data   | in   | signed [W-1:0] Ã- ROWS              | Input data array for the specified column                                |
// | rd_col_en     | in   | 1 bit (logic)                      | Column read enable (port b)                                              |
// | rd_col        | in   | [$clog2(COLS)-1:0]                 | Column address to read                                                   |
// | rd_col_data   | out  | signed [W-1:0] Ã- ROWS              | Output data from the selected column                                     |
