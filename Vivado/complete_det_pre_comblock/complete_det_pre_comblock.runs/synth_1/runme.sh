...
HD_PWD='C:/Users/gm/Vivado Projects/complete_det_pre_comblock/complete_det_pre_comblock.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pm_top_mux.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pm_top_mux.tcl
