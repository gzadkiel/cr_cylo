...
HD_PWD='C:/Users/gm/Vivado Projects/complete_det_pre_comblock/complete_det_pre_comblock.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log pm_top_mux.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source pm_top_mux.tcl -notrace
